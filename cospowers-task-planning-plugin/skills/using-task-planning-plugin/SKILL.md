---
name: using-task-planning-plugin
...
- Skill name: `using-task-planning-plugin`
...
4. Explain that implementation plans created through `writing-plans` pass through the local `plan-evaluator` quality gate before downstream handoff.
