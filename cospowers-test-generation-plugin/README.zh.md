...
- 在多轮测试设计中保存或恢复会话上下文，便于 TDD 开发和集成验证交接。
...
- 会话上下文摘要或归档说明：记录测试范围、风险、假设、排除项、未验证区域和后续交接信息。
...
5. 如果要继续推进，可以把测试用例和会话上下文交给 TDD 开发流程实现。
...
| `session-context` | 整理、恢复或归档当前测试生成会话上下文。 | 会话较长，需要保留背景、决策和未解决问题。 |
