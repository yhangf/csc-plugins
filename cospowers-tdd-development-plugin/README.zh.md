...
- 会话上下文摘要或归档说明：记录实现决策、验证结果、风险、未解决问题和后续交接信息。
...
6. 如果要继续推进，可以把实现总结、验证结果和会话上下文交给集成验证流程。
...
| `session-context` | 整理、恢复或归档当前编码会话上下文。 | 会话较长，需要保留背景、决策和未解决问题。 |
