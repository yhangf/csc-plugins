...
- `docs/verification/branch-finish-report.md`：开发分支收尾报告，记录最终状态、检查项和审查准备信息。
- 会话上下文摘要或归档说明：记录验证证据、环境限制、风险、阻塞项和后续交接信息。
...
6. 如果要继续推进，可以把验证结论、证据和会话上下文交给发布、审查或后续修复流程。
...
| `session-context` | 整理、恢复或归档当前验证会话上下文。 | 会话较长，需要保留背景、决策、证据和未解决问题。 |
